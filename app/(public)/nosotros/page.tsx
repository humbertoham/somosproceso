...
export default function AboutPage() {
  return <div className="page-wrap about-page"><header className="page-hero split-hero"><div><p className="eyebrow">Quiénes somos</p><h1>Un espacio humano para seguir creciendo.</h1></div><p>Somos Proceso crea experiencias de aprendizaje para hacer pausa, comprender lo que vivimos y practicar nuevas maneras de relacionarnos.</p></header>
    <section className="about-story"><div className="organic-panel" aria-hidden="true"><Image src="/logo.svg" alt="" width={1500} height={1500} sizes="(max-width: 800px) 90vw, 40vw" /><span>presencia</span><span>claridad</span><span>cuidado</span></div><div><p className="eyebrow">Nuestro enfoque</p><h2>Aprender también puede sentirse cercano.</h2><p>Abordamos temas de desarrollo humano, psicoeducación, inteligencia emocional y comunicación con un lenguaje claro y aplicable a la vida cotidiana.</p><p>No buscamos respuestas rápidas ni fórmulas idénticas para todas las personas. Valoramos la reflexión, el contexto y el proceso de cada quien.</p></div></section>
